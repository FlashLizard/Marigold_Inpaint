...
from marigold_controlnet.base_dataset import BaseDataset
...
if "__main__" == __name__:
    ...
    # Validation dataset
    val_loader: DataLoader = train_loader1
    ...
    vis_loader: DataLoader = train_loader2
    ...
    model = ControlNetMarigoldPipeline.from_pretrained(
        "checkpoint/marigold-depth-v1-0",
